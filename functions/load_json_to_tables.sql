CREATE OR REPLACE FUNCTION load_json_to_tables(json_array jsonb)
RETURNS VOID AS $$
DECLARE
    json_element jsonb;
BEGIN
    ...
    LOOP
        ...
        VALUES (
            ...
            (json_element -> 'data' -> 'order' ->> 'orderDate')::timestamptz,
            (json_element -> 'data' -> 'order' ->> 'completeDate')::timestamptz,
