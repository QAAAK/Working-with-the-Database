...
class gpload:
            ...
            try:
                try:
                    if argv[0]=='-h':
                        ...
                        sys.stderr.write("gpload version 6.22.1 build commit:a15fdc9c3b2ed5b800b39dab4c7124e56266078c\n")
                        sys.exit(0)
                    elif argv[0]=='-v':
    ...
    def read_table_metadata(self):
        ...
        # добавил Санталов (убрал последний предикат в запросе queryString)
