...
with DAG (
    dag_id = "LOAD_VRB_DET_DEPOSITDEAL",
   ...
   schedule_interval = '0 7 * * *',
    ...
    sql = """
        ...
        'HELLO_UBAD', CURRENT_TIMESTAMP FROM gl.budm_vrb_vrb_det_depositdeal where id_process>(select max(id_process)
        from gl."cdwh$budm_vrb$vrb_det_depositdeal"));
        """
    )
